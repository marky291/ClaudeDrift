...
[![tests](https://img.shields.io/badge/tests-21%20passing-brightgreen)](./test/run.mjs)
...
└── test/run.mjs                  # 21-case precision regression suite
```
...
```bash
npm test    # 21-case precision regression suite
```
